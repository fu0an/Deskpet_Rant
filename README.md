...
- **互动反馈**：快速晃它 / 反复睁闭眼会露出烦躁表情吐槽（闭眼中被吵也会短暂睁眼后睡回）；长按=戳它，清醒会撒娇、睡觉只说梦话
...
请到 Releases 页面下载最新版压缩包：https://github.com/fu0an/Deskpet_Rant/releases

1. 解压后双击 `Rant机.exe`
2. 点桌面上的小方块 → 左侧齿轮 → 设置
3. 选服务商（默认智谱 GLM），粘贴 API key，保存
